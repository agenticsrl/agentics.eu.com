    ...
    <>
      ...
      <div className="section container-content">
        <div>
          ...
          <div className="text-inkMuted mb-12">
          ...
          <div className="text-ink/80 space-y-12">
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '1. Titolare del Trattamento' : '1. Data Controller'}</h2>
              <div className="space-y-4">
                <div>
                  <p className="font-semibold text-ink text-lg mb-2">Agentics SRL</p>
                  <p className="leading-relaxed">{language === 'it' ? 'Viale Bruno Buozzi 77, 00197 Roma (RM) – Italia' : 'Viale Bruno Buozzi 77, 00197 Roma (RM) – Italy'}</p>
                  ...
                  <p className="leading-relaxed">Email: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></p>
                  <p className="leading-relaxed">PEC: <a href="mailto:agentics@pec.it" className="text-ink hover:underline break-words">agentics@pec.it</a></p>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '2. Ambito di Applicazione' : '2. Scope of Application'}</h2>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '3. Tipologie di Dati Personali Trattati' : '3. Types of Personal Data Processed'}</h2>
                ...
                <div>
                  ...
                  <div className="pl-4 space-y-6">
                    ...
                    <div>
                      ...
                      <ScrollableX label={language === 'it' ? 'Tabella' : 'Table'}>
                        <table className="table-data min-w-[34rem]">
                          <thead>
                            <tr className="bg-surface">
                              <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Responsabile' : 'Processor'}</th>
                              <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Finalità' : 'Purpose'}</th>
                              <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Sede' : 'Location'}</th>
                              <th className="border border-line px-4 py-3 text-left font-semibold">Privacy Policy</th>
                              <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Garanzie Trasferimento' : 'Transfer Safeguards'}</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td className="border border-line px-4 py-3">OpenAI, L.L.C.</td>
                              <td className="border border-line px-4 py-3">{language === 'it' ? 'Elaborazione conversazioni AI tramite modelli linguistici (GPT)' : 'AI conversation processing through language models (GPT)'}</td>
                              <td className="border border-line px-4 py-3">USA (California)</td>
                              <td className="border border-line px-4 py-3"><a href="https://openai.com/policies/privacy-policy" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">Privacy Policy OpenAI</a></td>
                              <td className="border border-line px-4 py-3">EU-US Data Privacy Framework + SCC</td>
                            </tr>
                            <tr className="bg-surface">
                              <td className="border border-line px-4 py-3">n8n GmbH</td>
                              <td className="border border-line px-4 py-3">{language === 'it' ? 'Orchestrazione workflow e automazione conversazioni chatbot' : 'Workflow orchestration and chatbot conversation automation'}</td>
                              <td className="border border-line px-4 py-3">{language === 'it' ? 'Germania (EU)' : 'Germany (EU)'}</td>
                              <td className="border border-line px-4 py-3"><a href="https://n8n.io/legal/privacy" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">Privacy Policy n8n</a></td>
                              <td className="border border-line px-4 py-3">{language === 'it' ? 'Sede UE - Nessun trasferimento extra-UE' : 'EU headquarters - No extra-EU transfer'}</td>
                            </tr>
                          </tbody>
                        </table>
                      </ScrollableX>
                    ...
                    <div>
                      ...
                      <div className="bg-surface border-l-2 border-lineStrong p-4">
                        <p className="leading-relaxed mb-2 font-semibold text-ink">{language === 'it' ? 'Attenzione: Non inserire dati sensibili nel chatbot' : 'Warning: Do not enter sensitive data in the chatbot'}</p>
                        <p className="leading-relaxed mb-2 text-ink">{language === 'it' ? 'Ti consigliamo di NON condividere tramite chatbot:' : 'We advise you NOT to share via chatbot:'}</p>
                        <ul className="list-disc pl-8 space-y-1 text-ink">
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-8 space-y-2">
                        <li>Email: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></li>
                    ...
                    <div>
                      ...
                      <p className="leading-relaxed mb-3">
                        {language === 'it'
                          ? <>Puoi esercitare tutti i diritti GDPR (accesso, cancellazione, rettifica, ecc.) anche sui dati raccolti tramite chatbot scrivendo a: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>
                          : <>You can exercise all GDPR rights (access, deletion, rectification, etc.) also on data collected through the chatbot by writing to: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>}
                      </p>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '4. Finalità e Basi Giuridiche del Trattamento' : '4. Purposes and Legal Bases for Processing'}</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <ScrollableX label={language === 'it' ? 'Tabella' : 'Table'}>
                    <table className="table-data min-w-[34rem]">
                      <thead>
                        <tr className="bg-surface">
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Finalità' : 'Purpose'}</th>
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Base Giuridica' : 'Legal Basis'}</th>
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Dati Trattati' : 'Data Processed'}</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Rispondere a richieste informazioni' : 'Responding to information requests'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Art. 6(1)(b) GDPR - Misure precontrattuali' : 'Art. 6(1)(b) GDPR - Pre-contractual measures'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Nome, email, telefono, messaggio' : 'Name, email, phone, message'}</td>
                        </tr>
                        <tr className="bg-surface">
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Invio newsletter/comunicazioni marketing' : 'Sending newsletter/marketing communications'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Art. 6(1)(a) GDPR - Consenso esplicito' : 'Art. 6(1)(a) GDPR - Explicit consent'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Email, nome' : 'Email, name'}</td>
                        </tr>
                        <tr>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Migliorare esperienza utente e funzionalità sito' : 'Improving user experience and site functionality'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Art. 6(1)(f) GDPR - Legittimo interesse' : 'Art. 6(1)(f) GDPR - Legitimate interest'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Dati navigazione, analytics' : 'Navigation data, analytics'}</td>
                        </tr>
                        <tr className="bg-surface">
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Sicurezza informatica e prevenzione frodi' : 'IT security and fraud prevention'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Art. 6(1)(f) GDPR - Legittimo interesse' : 'Art. 6(1)(f) GDPR - Legitimate interest'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'IP, log accessi' : 'IP, access logs'}</td>
                        </tr>
                        <tr>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Adempimenti fiscali/contabili' : 'Tax/accounting obligations'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Art. 6(1)(c) GDPR - Obbligo legale' : 'Art. 6(1)(c) GDPR - Legal obligation'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Dati fatturazione' : 'Billing data'}</td>
                        </tr>
                        <tr className="bg-surface">
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Difesa diritti in sede giudiziaria' : 'Defense of rights in court'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Art. 6(1)(f) GDPR - Legittimo interesse' : 'Art. 6(1)(f) GDPR - Legitimate interest'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Tutti i dati pertinenti' : 'All relevant data'}</td>
                        </tr>
                        <tr>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Esecuzione contratti di sviluppo software su commessa' : 'Execution of custom software development contracts'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Art. 6(1)(b) GDPR - Esecuzione contratto' : 'Art. 6(1)(b) GDPR - Contract performance'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Dati tecnici, dati di test, comunicazioni di progetto' : 'Technical data, test data, project communications'}</td>
                        </tr>
                      </tbody>
                    </table>
                  </ScrollableX>
                ...
                <div>
                  ...
                  <p className="leading-relaxed pl-4 mt-3">
                    {language === 'it'
                      ? <>Puoi opporti al trattamento basato su legittimo interesse scrivendo a: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>
                      : <>You can object to processing based on legitimate interest by writing to: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>}
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '5. Conservazione dei Dati' : '5. Data Retention'}</h2>
                ...
                <div>
                  ...
                  <ScrollableX label={language === 'it' ? 'Tabella' : 'Table'}>
                    <table className="table-data min-w-[34rem]">
                      <thead>
                        <tr className="bg-surface">
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Tipologia' : 'Type'}</th>
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Periodo di Conservazione' : 'Retention Period'}</th>
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Motivazione' : 'Reason'}</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Richieste precontrattuali (no contratto firmato)' : 'Pre-contractual requests (no signed contract)'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? '24 mesi dall\'ultimo contatto' : '24 months from last contact'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Gestione relazione commerciale' : 'Commercial relationship management'}</td>
                        </tr>
                        <tr className="bg-surface">
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Clienti attivi' : 'Active clients'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Durata rapporto contrattuale + 10 anni' : 'Duration of contractual relationship + 10 years'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Obblighi fiscali (DPR 600/73, art. 2220 c.c.)' : 'Tax obligations (DPR 600/73, art. 2220 c.c.)'}</td>
                        </tr>
                        <tr>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Candidature spontanee (CV)' : 'Unsolicited applications (CV)'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? '24 mesi da invio' : '24 months from submission'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Gestione recruiting' : 'Recruitment management'}</td>
                        </tr>
                        <tr className="bg-surface">
                          <td className="border border-line px-4 py-3">Cookie analytics</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? '26 mesi' : '26 months'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Linee guida Garante Privacy' : 'Data Protection Authority guidelines'}</td>
                        </tr>
                        <tr>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Log di sicurezza' : 'Security logs'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? '12 mesi' : '12 months'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Art. 32 GDPR - sicurezza' : 'Art. 32 GDPR - security'}</td>
                        </tr>
                        <tr className="bg-surface">
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Backup di sicurezza' : 'Security backups'}</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? '90 giorni' : '90 days'}</td>
                          <td className="border border-line px-4 py-3">Business continuity</td>
                        </tr>
                      </tbody>
                    </table>
                  </ScrollableX>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '6. Destinatari dei Dati e Comunicazione a Terzi' : '6. Data Recipients and Third-Party Disclosure'}</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <ScrollableX label={language === 'it' ? 'Tabella' : 'Table'}>
                    <table className="table-data min-w-[34rem]">
                      ...
                      <tbody>
                        <tr>
                          <td className="border border-line px-4 py-3">Google LLC (Analytics)</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Statistiche utilizzo sito' : 'Website usage statistics'}</td>
                          <td className="border border-line px-4 py-3">USA</td>
                          <td className="border border-line px-4 py-3">EU-US Data Privacy Framework + SCC</td>
                        </tr>
                      </tbody>
                    </table>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '7. Trasferimenti Internazionali di Dati' : '7. International Data Transfers'}</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-3 pl-4">
                    <div>
                      ...
                      <p className="leading-relaxed pl-4">{language === 'it' ? 'Elenco' : 'List'}: <a href="https://www.dataprivacyframework.gov/list" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">https://www.dataprivacyframework.gov/list</a></p>
                    </div>
                    <div>
                ...
                <div>
                  ...
                  <ScrollableX label={language === 'it' ? 'Tabella' : 'Table'}>
                    <table className="table-data min-w-[34rem]">
                      <thead>
                        <tr className="bg-surface">
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Fornitore' : 'Provider'}</th>
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Sede' : 'Location'}</th>
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Garanzie Adottate' : 'Safeguards Adopted'}</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="border border-line px-4 py-3">Google LLC</td>
                          <td className="border border-line px-4 py-3">USA (California)</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'DPF + SCC + Crittografia end-to-end' : 'DPF + SCC + End-to-end encryption'}</td>
                        </tr>
                      </tbody>
                    </table>
                  </ScrollableX>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '8. Diritti dell\'Interessato' : '8. Data Subject Rights'}</h2>
              ...
              <div className="space-y-6">
                  ...
                  <div className="pl-4 space-y-3">
                    <div>
                      ...
                      <ul className="list-disc pl-8 space-y-1">
                        <li>Email: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></li>
                        <li>PEC: <a href="mailto:agentics@pec.it" className="text-ink hover:underline break-words">agentics@pec.it</a></li>
                        <li>{language === 'it' ? 'Posta' : 'Mail'}: Viale Bruno Buozzi 77, 00197 Roma (RM)</li>
                      </ul>
                    </div>
                    <div>
                ...
                <div>
                  ...
                  <div className="pl-4">
                    ...
                    <p className="leading-relaxed">Web: <a href="https://www.garanteprivacy.it" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">www.garanteprivacy.it</a></p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '9. Sicurezza dei Dati' : '9. Data Security'}</h2>
              <div className="space-y-6">
                <div>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '10. Processo Decisionale Automatizzato e Profilazione' : '10. Automated Decision-Making and Profiling'}</h2>
              <div className="space-y-6">
                <div>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '11. Registro delle Attività di Trattamento (Art. 30 GDPR)' : '11. Record of Processing Activities (Art. 30 GDPR)'}</h2>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '12. Valutazione d\'Impatto sulla Protezione dei Dati (DPIA - Art. 35 GDPR)' : '12. Data Protection Impact Assessment (DPIA - Art. 35 GDPR)'}</h2>
              <div className="space-y-6">
                <div>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '13. Privacy by Design e by Default (Art. 25 GDPR)' : '13. Privacy by Design and by Default (Art. 25 GDPR)'}</h2>
              <div className="space-y-6">
                <div>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '14. Cookie e Tecnologie di Tracciamento' : '14. Cookies and Tracking Technologies'}</h2>
              <div className="space-y-6">
                <div>
                ...
                <div>
                  ...
                  <ScrollableX label={language === 'it' ? 'Tabella' : 'Table'} className="pl-4">
                    <table className="table-data min-w-[34rem]">
                      <thead>
                        <tr className="bg-surface">
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Servizio' : 'Service'}</th>
                          <th className="border border-line px-4 py-3 text-left font-semibold">{language === 'it' ? 'Tipo' : 'Type'}</th>
                          <th className="border border-line px-4 py-3 text-left font-semibold">Privacy Policy</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="border border-line px-4 py-3">Google Analytics</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Analitico' : 'Analytical'}</td>
                          <td className="border border-line px-4 py-3"><a href="https://policies.google.com/privacy" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">Privacy Policy</a></td>
                        </tr>
                        <tr className="bg-surface">
                          <td className="border border-line px-4 py-3">Google Fonts</td>
                          <td className="border border-line px-4 py-3">{language === 'it' ? 'Tecnico' : 'Technical'}</td>
                          <td className="border border-line px-4 py-3"><a href="https://policies.google.com/privacy" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">Privacy Policy</a></td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-8 space-y-2 mb-3">
                    ...
                    <li>{language === 'it' ? <>Scrivere a: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></> : <>Write to: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>}</li>
                  </ul>
                  <div className="pl-4 space-y-3">
                    <div>
                ...
                <div>
                  ...
                  <div className="pl-4 space-y-3">
                    ...
                    <a href="https://tools.google.com/dlpage/gaoptout" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">https://tools.google.com/dlpage/gaoptout</a></p>
                    <div>
                      <p className="leading-relaxed mb-2">Advertising opt-out:</p>
                      <ul className="list-disc pl-8 space-y-1">
                        <li>{language === 'it' ? 'Network pubblicitari' : 'Advertising networks'}: <a href="http://www.youronlinechoices.eu" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">www.youronlinechoices.eu</a></li>
                        <li>NAI opt-out: <a href="http://www.networkadvertising.org/choices" className="text-ink hover:underline break-words" target="_blank" rel="noopener noreferrer">www.networkadvertising.org/choices</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '15. Modifiche a questa Informativa' : '15. Changes to this Policy'}</h2>
              <div className="space-y-4">
                <div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed pl-4">
                    {language === 'it'
                      ? <>Manteniamo uno storico delle versioni precedenti disponibile su richiesta a: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>
                      : <>We maintain a history of previous versions available upon request at: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>}
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '16. Minori di Età' : '16. Minors'}</h2>
              <div className="space-y-4">
                <div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed pl-4">
                    {language === 'it'
                      ? <>Se sei genitore/tutore e rilevi che tuo figlio ha fornito dati personali, contattaci immediatamente: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>
                      : <>If you are a parent/guardian and discover that your child has provided personal data, contact us immediately: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>}
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '17. Link a Siti di Terze Parti' : '17. Links to Third-Party Websites'}</h2>
              <div className="space-y-4">
                <div>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '18. Contatti e Richieste' : '18. Contacts and Requests'}</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <div className="pl-4 space-y-1">
                    ...
                    <p className="leading-relaxed">{language === 'it' ? 'Posta' : 'Mail'}: Viale Bruno Buozzi 77, 00197 Roma (RM) – {language === 'it' ? 'Italia' : 'Italy'}</p>
                  </div>
                </div>
                <div>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '19. Informazioni Supplementari per Clienti B2B' : '19. Additional Information for B2B Clients'}</h2>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed pl-4">
                    {language === 'it'
                      ? <>Puoi richiedere copia del DPA (per servizi AI SaaS o sviluppo software) firmato a: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>
                      : <>You can request a copy of the signed DPA (for AI SaaS services or software development) at: <a href="mailto:info@agentics.eu.com" className="text-ink hover:underline break-words">info@agentics.eu.com</a></>}
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '20. Glossario GDPR' : '20. GDPR Glossary'}</h2>
              <div className="space-y-3 pl-4">
            ...
            <section className="space-y-6">
              <h2 className="font-display font-bold text-3xl text-ink border-b-2 border-ink pb-3">{language === 'it' ? '21. Dichiarazione Finale' : '21. Final Declaration'}</h2>
            ...
            <div className="mt-16 pt-8 border-t-2 border-line text-center space-y-2">
              ...
              <p className="text-sm text-ink/60">{language === 'it' ? 'Versione' : 'Version'}: 2.1</p>
              <p className="text-sm text-ink/60">{language === 'it' ? 'Prossima revisione prevista: Marzo 2027' : 'Next scheduled review: March 2027'}</p>
              <p className="text-sm text-ink/60 mt-4">© 2025–2026 Agentics SRL – {language === 'it' ? 'Tutti i diritti riservati' : 'All rights reserved'}</p>
              <p className="text-sm text-ink/60">{language === 'it' ? 'P.IVA' : 'VAT'}: 03335160598</p>
            </div>
          </div>
        </div>
      </div>
