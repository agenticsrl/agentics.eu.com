...
/**
 * Testo che si apre come pannelli incernierati (React Bits, portato a TypeScript).
 * È l'unico elemento animato del sito: l'intestazione della home lo usa per la
 * parola che ruota accanto al nome dell'azienda.
 */
      ...
      return (
        ...
        >
          <span
            ...
            style={
              { transformOrigin: hingeConfig.origin, '--fold-crease': 0 } as React.CSSProperties
            }
          >
            {content || ' '}
          </span>
